...
"""Compatibility wrapper that re-exports ``saaaaaa.utils.contracts`` under the legacy name.

The implementation now lives in ``saaaaaa.utils.contracts``, but several integration tests
...
_SOURCE_MODULE_NAME = "saaaaaa.utils.contracts"
