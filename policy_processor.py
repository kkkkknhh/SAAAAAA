...
"""Compatibility wrapper that re-exports ``saaaaaa.processing.policy_processor`` under the legacy name.

The implementation now lives in ``saaaaaa.processing.policy_processor``, but several integration tests
...
_SOURCE_MODULE_NAME = "saaaaaa.processing.policy_processor"
