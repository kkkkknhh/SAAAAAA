...
class ReportAssembler:
    ...
    def generate_macro_convergence(
        ...
        probative_tests = self._summarize_probative_tests(all_micro_answers)
        coverage_index = self._calculate_dimension_coverage_index(
            all_micro_answers, plan_metadata
        )
        gating_report = self._validate_macro_gating(
            all_micro_answers, coverage_index
        )
        ...
        metadata = {
            ...
            "probative_tests": probative_tests,
            "coverage_index": coverage_index,
            "macro_gating": gating_report,
        }
