...
"""Compatibility wrapper that re-exports ``saaaaaa.processing.embedding_policy`` under the legacy name.

The implementation now lives in ``saaaaaa.processing.embedding_policy``, but several integration tests
...
_SOURCE_MODULE_NAME = "saaaaaa.processing.embedding_policy"
