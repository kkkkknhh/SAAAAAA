...
class TestDependencyLockdown:
    ...
    def setup_method(self):
        """Reset lockdown before each test."""
        reset_dependency_lockdown()
    ...
    def test_offline_mode_explicit_zero(self):
    ...
    def test_online_mode_enabled(self):
    ...
    def test_check_online_model_access_offline_raises(self):
    ...
    def test_check_online_model_access_online_succeeds(self):
    ...
    def test_check_critical_dependency_missing_raises(self):
    ...
    def test_check_critical_dependency_present_succeeds(self):
    ...
    def test_check_optional_dependency_missing_returns_false(self):
    ...
    def test_check_optional_dependency_present_returns_true(self):
    ...
    def test_singleton_get_dependency_lockdown(self):
    ...
    def test_reset_dependency_lockdown(self):
...
class TestEmbeddingPolicyIntegration:
    ...
    def test_embedding_model_init_offline_no_cache_raises(self):
    ...
    def test_cross_encoder_init_offline_no_cache_raises(self):
...
class TestOrchestratorIntegration:
    ...
    def test_orchestrator_initializes_lockdown(self):
    ...
    def test_orchestrator_respects_hf_online(self):
