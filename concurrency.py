...
"""Compatibility wrapper that re-exports ``saaaaaa.concurrency.concurrency`` under the legacy name.

The implementation now lives in ``saaaaaa.concurrency.concurrency``, but several integration tests
...
_SOURCE_MODULE_NAME = "saaaaaa.concurrency.concurrency"
