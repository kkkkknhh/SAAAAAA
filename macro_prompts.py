...
"""Compatibility wrapper that re-exports ``saaaaaa.analysis.macro_prompts`` under the legacy name.

The implementation now lives in ``saaaaaa.analysis.macro_prompts``, but several integration tests
...
_SOURCE_MODULE_NAME = "saaaaaa.analysis.macro_prompts"
