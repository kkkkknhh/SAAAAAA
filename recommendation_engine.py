...
"""Compatibility wrapper that re-exports ``saaaaaa.analysis.recommendation_engine`` under the legacy name.

The implementation now lives in ``saaaaaa.analysis.recommendation_engine``, but several integration tests
...
_SOURCE_MODULE_NAME = "saaaaaa.analysis.recommendation_engine"
