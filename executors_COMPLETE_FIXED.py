"""
EJECUTORES CON TODOS LOS MÉTODOS DEL CATÁLOGO
==============================================

Estrategia SIMPLE y CORRECTA:
- Para cada pregunta, llamar TODOS los métodos listados en el catálogo
- En secuencia simple (sin intentar ser inteligente con el flow)
- Data flow: output método N → input método N+1
"""
